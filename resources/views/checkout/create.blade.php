            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2">
                    <div class="bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
                        <div class="flex justify-between items-center mb-6">
                            ...
                            <div class="flex space-x-3 text-xs font-semibold">
                                <div class="flex items-center"><span
                                        class="w-3 h-3 bg-white border-2 border-gray-300 rounded mr-1"></span> Tersedia
                                </div>
                                <div class="flex items-center"><span class="w-3 h-3 bg-indigo-600 rounded mr-1"></span>
                                    Dipilih</div>
                                <div class="flex items-center"><span class="w-3 h-3 bg-gray-200 rounded mr-1"></span>
                                    Terjual</div>
                            </div>
                        </div>
                        ...
                        {{-- STAGE --}}
                        <div
                            class="w-full h-12 bg-gray-100 rounded-t-full mb-10 flex items-center justify-center border-t border-l border-r border-gray-200 shadow-inner">
                            <span class="text-gray-400 font-bold tracking-[0.5em] text-xs uppercase">STAGE /
                                SCREEN</span>
                        </div>
                    ...
                    <div class="bg-white p-6 rounded-3xl shadow-lg border border-indigo-50 sticky top-6">
                        ...
                        <form action="{{ route('transaction.store') }}" method="POST" id="checkoutForm">
                            ...
                            <div class="mb-6">
                                ...
                                <div
                                    class="relative bg-black rounded-xl overflow-hidden h-48 w-full mb-3 group shadow-inner">
                                    <video id="video"
                                    ...
                                    {{-- Overlay --}}
                                    <div
                                        class="absolute inset-0 border-2 border-indigo-500/30 m-6 rounded-lg pointer-events-none">
                                    </div>
                                </div>

                                <div class="flex gap-2">
                                    <button type="button" id="snap"
                                        class="flex-1 bg-white border border-gray-300 text-gray-700 py-2 rounded-lg font-bold text-xs hover:bg-gray-50 transition">
                                        Ambil Foto
                                    </button>
                                    <button type="button" id="retake"
                                        class="hidden flex-1 bg-red-50 text-red-600 border border-red-100 py-2 rounded-lg font-bold text-xs hover:bg-red-100 transition">
                                        Ulangi
                                    </button>
                                </div>
                            </div>
                            ...
                            <button type="submit" id="pay_button" disabled
                                class="w-full bg-gray-300 text-gray-500 py-3 rounded-xl font-bold text-lg transition-all duration-300 cursor-not-allowed">
                                Bayar & Amankan
                            </button>
                        </form>
                    </div>

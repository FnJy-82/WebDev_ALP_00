<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @auth
                        <!-- MENU KHUSUS CUSTOMER (DAFTAR EO) -->
            ...
            <!-- Settings Dropdown (Menu Kanan - Desktop) -->
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @else
                    ...
                    <div class="space-x-4">
                        <a href="{{ route('login') }}" class="text-sm text-gray-700 font-semibold hover:text-gray-900">Log in</a>
                        <a href="{{ route('register') }}" class="text-sm text-gray-700 font-semibold hover:text-gray-900 border border-gray-300 rounded px-3 py-1 hover:bg-gray-50">Register</a>
                    </div>
                @endauth
            </div>
    ...
    <!-- Responsive Navigation Menu (Tampilan Mobile saat Hamburger diklik) -->
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            @else
                <!-- TAMPILAN MOBILE: GUEST (BELUM LOGIN) -->
                <div class="mt-3 space-y-1">
